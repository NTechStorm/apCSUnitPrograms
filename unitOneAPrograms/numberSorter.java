...
public class numberSorter
{
    public static void main(String args[]) {
        ...
        System.out.println("Enter three numbers separated by a enter: ");
        ...
        } else if (numberArray[1] < numberArray[0] && numberArray[1] < numberArray[2]) {
        ...
        } else if (numberArray[2] < numberArray[0] && numberArray[2] < numberArray[1]) {
